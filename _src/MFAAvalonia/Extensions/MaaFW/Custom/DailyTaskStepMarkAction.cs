...
/// <summary>记录一次日课项目进度，供锻刀、演练等按游戏日累计多次的项目使用。</summary>
public sealed class DailyTaskStepMarkAction : IMaaCustomAction
{
    public string Name { get; set; } = nameof(DailyTaskStepMarkAction);
